...
대시보드 하단의 QR은
[공식 Notion 상세 가이드](https://app.notion.com/p/Classroom-TV-Lite-3dd54b03965e8047b272df3015806757?source=copy_link)로 연결됩니다.
...
4. 설치가 끝나면 서버가 자동으로 다시 시작되고 설정 화면이 새로고침됩니다.
   보통은 `python app.py`를 다시 실행할 필요가 없습니다.
